package com.dick.net.msg  {
	...
	public dynamic final class RoleInfo extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const ROLEID:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("RoleInfo.roleId", "roleId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NAME:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("RoleInfo.name", "name", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const LEVEL:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("RoleInfo.level", "level", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (roleId$count != 0) {
						throw new flash.errors.IOError('Bad data format: RoleInfo.roleId cannot be set twice.');
					}
					++roleId$count;
